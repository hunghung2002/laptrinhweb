        ...
        <div class="section group">
            ...
            <div class="cont-desc span_1_of_2" style="width: 65%;">
                <div class="grid images_3_of_2">
                    <img style="width:auto;" src="./img/samsung-galaxy-s20.jpg" alt="" >
                </div>
                <div class="desc span_3_of_2">
                    <h2 style="margin: 30px 0px;color: #4b2d2d;background-color:#c2e9ed;">Điện thoại  Samsung Galaxy S20 FE (8GB/256GB)</h2>
                    <p>Chip: Snapdragon 865</p>
                    <p>RAM: 8 GB</p>
                    <p>Bộ nhớ trong: 256 GB</p>
                    <div class="price">
                        <p>Giá: <span>17<sub>$</sub></span></p>
                        <p>Loại: <span>Smart Phone</span></p>
                        <p>Hãng:<span>Samsung</span></p>
                    </div>
                    <div class="add-cart">
                ...
                <div class="product-desc" style="width: 35%; padding:7px; ">
                    <h2>Cấu hình Điện thoại Samsung Galaxy S20 FE (8GB/256GB)</h2>
                    <p></p>
                    <p style="background: #ddd;padding: 12px;">Màn hình: Super AMOLED6.5"Full HD+</p>
                    <p style="padding: 12px;margin-top:-1rem;">Camera sau: Chính 12 MP & Phụ 12 MP, 8 MP</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">Camera trước: 32 MP</p>
                    <p style="padding: 12px;margin-top:-1rem;">Chip: Snapdragon 865</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">RAM: 8 GB</p>
                    <p style="padding: 12px;margin-top:-1rem;">Bộ nhớ trong: 256 GB</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">SIM: 2 Nano SIM (SIM 2 chung khe thẻ nhớ)Hỗ trợ 4G</p>
                    <p style="padding: 12px;margin-top:-1rem;">Pin, Sạc: 4500 mAh25 W</p>
                </div>
            </div>
