        ...
        <div class="section group">
            ...
            <div class="cont-desc span_1_of_2" style="width: 65%;">
                <div class="grid images_3_of_2">
                    <img style="width:auto;" src="./img/xiaomi-11t-grey.jpg" alt="" >
                </div>
                <div class="desc span_3_of_2">
                    <h2 style="margin: 30px 0px;color: #4b2d2d;background-color:#c2e9ed;">Điện thoại Xiaomi 11T 5G 256GB</h2>
                    <p>Chip: MediaTek Dimensity 1200</p>
                    <p>RAM: 8 GB</p>
                    <p>Bộ nhớ trong: 256 GB</p>
                    <div class="price">
                        <p>Giá: <span>15 <sub>$</sub></span></p>
                        <p>Loại: <span>Smart Phone</span></p>
                        <p>Hãng:<span>Xiaomi</span></p>
                    </div>
                    <div class="add-cart">
                ...
                <div class="product-desc" style="width: 35%; padding:7px; ">
                    ...
                    <p></p>
                    <p style="background: #ddd;padding: 12px;">Màn hình: AMOLED6.67"Full HD+</p>
                    <p style="padding: 12px;margin-top:-1rem;">Camera sau: Chính 108 MP & Phụ 8 MP, 5 MP</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">Camera trước: 16 MP</p>
                    <p style="padding: 12px;margin-top:-1rem;">Chip: MediaTek Dimensity 1200</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">RAM: 8 GB</p>
                    <p style="padding: 12px;margin-top:-1rem;">Bộ nhớ trong: 256 GB</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">SIM: 2 Nano SIM,Hỗ trợ 5G</p>
                    <p style="padding: 12px;margin-top:-1rem;">Pin, Sạc: 5000 mAh67 W</p>
                </div>
            </div>
