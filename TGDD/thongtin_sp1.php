    ...
    <nav>
        <div class="container">
            <ul>
                ...
                <li>
                    <button><a href="cart.php"><i class="fas fa-shopping-cart"></i>Giỏ hàng</a></button></li>
                </li>
        ...
        <div class="section group">
            ...
            <div class="cont-desc span_1_of_2" style="width: 65%;">
                <div class="grid images_3_of_2">
                    <img style="width:auto;" src="./img/iphone-13-pro-max.jpg" alt="" >
                </div>
                <div class="desc span_3_of_2">
                    <h2 style="margin: 30px 0px;color: #4b2d2d;background-color:#c2e9ed;">Điện thoại iPhone 13 Pro Max 128GB</h2>
                    <p>Chip: Apple A15 Bionic</p>
                    <p>RAM: 6 GB</p>
                    <p>Bộ nhớ trong: 128 GB</p>
                    <div class="price">
                        <p>Giá: <span>33 <sub>$</sub></span></p>
                        <p>Loại: <span>Smart Phone</span></p>
                        <p>Hãng:<span>Apple</span></p>
                    </div>
                    <div class="add-cart">
                ...
                <div class="product-desc" style="width: 35%; padding:7px; ">
                    <h2>Cấu hình Điện thoại iPhone 13 Pro Max 128GB</h2>
                    <p></p>
                    <p style="background: #ddd;padding: 12px;">Màn hình: OLED6.7"Super Retina XDR</p>
                    <p style="padding: 12px;margin-top:-1rem;">Camera sau: 3 camera 12 MP</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">Camera trước: 12 MP</p>
                    <p style="padding: 12px;margin-top:-1rem;">Chip: Apple A15 Bionic</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">RAM: 6 GB</p>
                    <p style="padding: 12px;margin-top:-1rem;">Bộ nhớ trong: 128 GB</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">SIM: 1 Nano SIM & 1 eSIMHỗ trợ 5G</p>
                    <p style="padding: 12px;margin-top:-1rem;">Pin, Sạc: 4352 mAh20 W</p>
                </div>
            </div>
            ...
            <div class="rightsidebar span_3_of_1">
                ...
                <ul style="background-color: #ddd;">
                    <li style="padding: 8px 0"><a style="font-size: 16px;" href="productbycat.php?catid=15">Test</a></li>
                    <li style="padding: 8px 0"><a style="font-size: 16px;" href="productbycat.php?catid=7">Software</a></li>
                    <li style="padding: 8px 0"><a style="font-size: 16px;" href="productbycat.php?catid=6">Accessories</a></li>
                    <li style="padding: 8px 0"><a style="font-size: 16px;" href="productbycat.php?catid=5">Mobile Phones</a></li>
                    <li style="padding: 8px 0"><a style="font-size: 16px;" href="productbycat.php?catid=4">Desktop</a></li>
                    <li style="padding: 8px 0"><a style="font-size: 16px;" href="productbycat.php?catid=3">Laptop</a></li>
                </ul>
