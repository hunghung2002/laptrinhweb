        ...
        <div class="section group">
            ...
            <div class="cont-desc span_1_of_2" style="width: 65%;">
                <div class="grid images_3_of_2">
                    <img style="width:auto;" src="./img/samsung-galaxy-s21.jpg" alt="" >
                </div>
                <div class="desc span_3_of_2">
                    <h2 style="margin: 30px 0px;color: #4b2d2d;background-color:#c2e9ed;">Điện thoại Samsung Galaxy S21 5G</h2>
                    <p>Chip: Exynos 2100</p>
                    <p>RAM: 8 GB</p>
                    <p>Bộ nhớ trong: 128 GB</p>
                    <div class="price">
                        <p>Giá: <span>23 <sub>$</sub></span></p>
                ...
                <div class="product-desc" style="width: 35%; padding:7px; ">
                    ...
                    <p></p>
                    <p style="background: #ddd;padding: 12px;">Màn hình: AMOLED6.43"Full HD+</p>
                    <p style="padding: 12px;margin-top:-1rem;">Camera sau: Chính 64 MP & Phụ 8 MP, 2 MP</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">Camera trước: 32 MP</p>
                    <p style="padding: 12px;margin-top:-1rem;">Chip: MediaTek Dimensity 800U 5G</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">RAM: 8 GB</p>
                    <p style="padding: 12px;margin-top:-1rem;">Bộ nhớ trong: 128 GB</p>
                    <p style="background: #ddd;padding: 12px;margin-top:-1rem;">SIM: 2 Nano SIMHỗ trợ 5G</p>
                    <p style="padding: 12px;margin-top:-1rem;">Pin, Sạc: 4310 mAh30 W</p>
                </div>
            </div>
